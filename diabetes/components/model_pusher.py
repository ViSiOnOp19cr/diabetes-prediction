...
from diabetes.entity.artifact_entity import ModelPusherArtifact, ModelEvaluationArtifact
...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        self.usvisa_estimator = diabetesEstimator(bucket_name=model_pusher_config.bucket_name,
